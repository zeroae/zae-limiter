...
class TestAuditArchival:
    ...
    async def test_audit_events_archived_to_s3(
        ...
        # Note: Bucket name is auto-generated by CloudFormation
        ...
        outputs = {
            o["OutputKey"]: o["OutputValue"] for o in stack_response["Stacks"][0].get("Outputs", [])
        }
        bucket_name = outputs.get("AuditArchiveBucketName")
        assert bucket_name, "AuditArchiveBucketName output not found in stack"
        # Bucket name is auto-generated by CloudFormation
        assert bucket_name, f"Expected non-empty bucket name, got {bucket_name}"
        ...
        scoped_repo = limiter._repository
        client = await scoped_repo._get_client()
