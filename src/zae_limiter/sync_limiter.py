...
def _reader_window_end(limit: Limit, bucket: BucketState) -> int | None:
    ...
    - **Shortened** (item long, config short): the item's ``vu`` was stamped
      ...
      limiter, which is the thing :meth:`SyncRateLimiter.check_availability`
      exists to prevent.
...
class SyncRateLimiter:
    ...
    def _do_acquire(
        ...
        for eid in entity_ids:
            ...
            seed_transfer = self._quota_seed_transfer(
    ...
    def _quota_seed_transfer(
        ...
        :meth:`SyncRepository.reclaim_quota_seed`.
        ...
        if not shares_milli:
            return {}
        return self._repository.reclaim_quota_seed(entity_id, resource, shares_milli)
    ...
    def check_availability(
        ...
        **Schedules.** Everything reported is the value in force at
        ...
        Example:
            ```python
            check = limiter.check_availability(
                entity_id="key-abc",
                resource="gpt-4",
