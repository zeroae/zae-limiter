...
class SyncRepositoryProtocol(Protocol):
    ...
    this protocol to work with SyncRateLimiter. The protocol is divided into:
    ...
    Example:
        ...
        repo = MyBackend()
        assert isinstance(repo, SyncRepositoryProtocol)  # True at runtime
    """
    ...
    def build_bucket_put_item(
        self, state: "BucketState", ttl_seconds: int = 86400
    ) -> dict[str, Any]:
        """
    ...
    def get_limits(self, entity_id: str, resource: str = "_default_") -> "list[Limit]":
        """
    ...
    def delete_limits(
        self, entity_id: str, resource: str = "_default_", principal: str | None = None
    ) -> None:
        """
    ...
    def resolve_limits(
        ...
        strategies. For DynamoDB, this uses SyncConfigCache with batched fetch
        optimization.
